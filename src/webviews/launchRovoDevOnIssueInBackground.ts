...
export class LaunchRovoDevOnIssueInBackgroundWebview
    ...
    implements InitializingWebview<MinimalIssue<DetailedSiteInfo>>
{
    ...
    public get title(): string {
        return 'Launch RovoDev on Jira Issue';
    }
    public get id(): string {
        return 'launchRovoDevOnIssueInBackgroundScreen';
    }
    ...
    public async updateIssue(issue: MinimalIssue<DetailedSiteInfo>) {
        ...
        try {
            ...
            Logger.error(e, 'LaunchRovoDevOnIssueInBackgroundWebview.updateIssue');
            this.postMessage({ type: 'error', reason: this.formatErrorReason(e) });
        } finally {
    ...
    private async forceUpdateIssue() {
        ...
        if (key !== '') {
            try {
                ...
                Logger.error(e, 'LaunchRovoDevOnIssueInBackgroundWebview.forceUpdateIssue');
                this.postMessage({ type: 'error', reason: this.formatErrorReason(e) });
            }
        }
    }
